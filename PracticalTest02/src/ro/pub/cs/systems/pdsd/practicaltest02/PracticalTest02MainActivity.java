...
public class PracticalTest02MainActivity extends Activity {
	...
	EditText portServer, porttClient, adressaToServer, word;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv = (TextView) findViewById(R.id.idText_view);
        btnStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
         	    ...
         	    if (serverThread.getServerSocket() != null) {
         	      serverThread.start();
         	      Toast.makeText( getApplicationContext(),"Serverul a pornit!", Toast.LENGTH_SHORT).show();
         	    } else {
        ...
        btnConnect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String clientAddress = adressaToServer.getText().toString();
                String clientPort    = porttClient.getText().toString();
